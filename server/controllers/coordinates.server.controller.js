    ...
    request({
      ...
      qs: options
		...
		req.body.coordinates = {
			latitude: myData.results[0].geometry.lat,
			longitude: myData.results[0].geometry.lng
		};
		*/


        //req.body.coordinates.latitude = myData.results[0].geometry.lat;
    	//req.body.coordinates.longitude = myData.results[0].geometry.lng;
        

        
		req.results = myData.results[0].geometry;
        ...
        /*Save the coordinates in req.results -> 
          ...
          req.results.lat = myData.geometry.lat;
        req.results.lng = myData.geometry.lng;
        */
